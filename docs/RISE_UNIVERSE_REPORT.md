...
| **Act 4: The Office**    | Marcus has a PUSH+ — same brand, premium tier. Karen had the Nudge: "Made me a VP." Young employee writes "beds??" in notebook. |
...
| **End Credits**          | The bed commutes home alone. People part around it. A dog watches. It enters the house, folds flat, waits. Remote glows.      |
...
| **Marcus**         | PUSH+ owner. Different tier, different colorway. Same wreckage.   |
