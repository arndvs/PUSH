...
*Each entry includes: Shot ID, Duration, Camera, Scene Description, AI Prompt, and Notes*
...
*For all Gauntlet shots: the bed is always in frame. It should feel like a relentless, patient chaperone. The camera should frequently favor WIDE angles so we see both Dave AND the bed in the same frame. Speed of movement increases with each location.*
