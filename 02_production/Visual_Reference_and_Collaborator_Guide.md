# PUSH — VISUAL REFERENCE & COLLABORATOR GUIDE
...
This is **dry physical comedy**. The key tonal models are:
...
The humor lives entirely in **Dave's resignation** and the **bed's relentless professionalism**.
...
The bed is not evil. It is not malicious. It simply has **a job and it is going to do that job**.
...
### SCENE 1 — Bedroom Opening

**The shot:** Blue-gray bedroom, pre-dawn. Dave, face-down, arm hanging off the bed.

**Key visual detail:** The glass of water on the nightstand, untouched. It should appear in almost every bedroom shot. It becomes a running visual joke — the water Dave never drinks. By the end of the film it's still there.

**Hold duration:** Hold the silence and stillness for 2–3 seconds before the alarm. The longer the silence, the bigger the alarm hit.
...
- Cab: warm tungsten, slight motion blur from passing lights

**Editing rhythm:** Cut on the beat of something propulsive. Each flashback is 2–4 seconds max. The whole montage should run no longer than 25 seconds. It's a summary, not a story.

**What NOT to show:** Nothing actually bad happening. No fighting, no embarrassing moments. The comedy is that this was a completely normal fun night — Dave is suffering purely due to volume.
...
### SCENE 4 — The Bed Rises

**This is the film's central mechanical gag. It needs to land perfectly.**

Shoot it from the side, wide enough to see the full bed. The comedy has three beats:
...
### SCENE 6 — Coffee Maker Intercut

**This shot is a palette cleanser.** Cut to it at the moment of maximum chaos — when Dave is being pushed fastest through the closet. Hold it for an unusually long time. The contrast is the joke.

**The coffee should look incredible.** Golden light, steam, perfect pour. Everything Dave is about to struggle to access.
...
### SCENE 8 — The Coffee Scene

**This is the film's primary physical set piece.**

The bed is faster here. Dave is jogging slightly. The kitchen should feel tight — the distance between the coffee and the door is not much.
...
**Mirror the opening exactly.** Same framing, same light, same glass of water. The cycle is complete. Nothing has changed. Everything will happen again.
